...
## Description
Throughout my time at Blue Stamp Engineering, I learned many things. Not only engineering skills, I learned how to communicate with a team, how to troubleshoot and how to think like a programmer, I learned how to make new connections with people and build a friendship. I enjoyed building my project and I love the envoirnment I worked in, BSE taught me a lot and gave me a deeper understanding about not only engineering but also about about myself as an indivisual. All in all, at BSE I learned many critical skills and made many connections with my fellow classmates and I really enjoyed working with all the instructors. 
...
## Challenges
During the planning of my project, I faced multiple challenges such as managing the cost, product efficiency and finding the correct sizing that is compatible with my project. In detail, to manage the cost of my modifications I used a recyclable cardboard box as the enclosure for my power bank, and as for efficiency I thought to make my project more versatile and applicable in real life and as a solution I found a solar powered power bank that outputs 42800 mHA, this power bank only costed 39$ instead of the original cost of 300$. I found this product on its biggest sale in its history, a surprising 90% discount. Lastly, to find the correct sizing for my enclosure for my project I used multiple tools and carefully planned and drew blueprints for my enclosure. To print my project, I used a 3D printer and by using a material called PETG, I was able to print an enclosure that is both environmentally friendly and also an enclosure that is able to endure harsh weather conditions. In conclusion, my modifications were not super challenging but instead it was a fun and enjoyable task, I really enjoyed making my modifications and I was really glad to see it work properly without any issues.
